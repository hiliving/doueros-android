...
public class AudioPlayerDeviceModule extends BaseDeviceModule {
    ...
    public void handleDirective(Directive directive) throws HandleDirectiveException {
        ...
        LogUtil.d("AAAAAAAAAAAA", "dcs-play-directiveName:" + directiveName);
    ...
    private void handlePlay(PlayPayload payload) {
        ...
        LogUtil.i("AAAAAAAAAAAA", "URL:" + streamUrl);
        LogUtil.i("AAAAAAAAAAAA", "StreamId:" + streamId);
        LogUtil.i("AAAAAAAAAAAA", "Offset:" + offset);
        add(stream);
    }
    ...
    private IMediaPlayer.IMediaPlayerListener mediaPlayerListener = new IMediaPlayer.SimpleMediaPlayerListener() {
        ...
        public void onUpdateProgress(int percent) {
            ...
            fireUpdateMillis(timer.getOffsetInMilliseconds());
        }
    };
    ...
    private void fireUpdateMillis(long millis) {
        for (IMediaPlayer.IMediaPlayerListener listener : audioPlayerListeners) {
            listener.onUpdateMills(millis);
        }
    }
