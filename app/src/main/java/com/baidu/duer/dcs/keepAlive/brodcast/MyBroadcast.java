package com.baidu.duer.dcs.keepAlive.brodcast;
...
import com.baidu.duer.dcs.keepAlive.ServiceMangerUtils;
...
public class MyBroadcast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(Intent.ACTION_TIME_TICK)) {//如果广播是每分钟发送一次的时间广播
            ...
            isServiceRunning = ServiceMangerUtils.isServiceWorked(DcsSampleApplication.getmContext(), "myservice1");
            if (!isServiceRunning) {
